(() => {
    ...
    function initSliders() {
        if (document.querySelector(".slider-info-info")) new swiper_core_Swiper(".slider-info-info", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
            ...
            speed: 800,
            navigation: {
                prevEl: ".info-info__arrow_rigth",
                nextEl: ".info-info__arrow_left"
            },
            on: {}
        });
    }
...
***************************************************************************** */
    ...
    window.addEventListener("scroll", (function(ev) {
        const headerMenu = document.querySelector(".bottom-header");
        const headerMenuTop = headerMenu.offsetTop;
        const headerMenuTopStatic = parseInt("240px");
        if (scrollY === headerMenuTop || scrollY > headerMenuTop) headerMenu.classList.add("_header-nemu-scroll");
        if (scrollY < headerMenuTopStatic) headerMenu.classList.remove("_header-nemu-scroll");
    }));
    window["FLS"] = true;
    isWebp();
    menuInit();
